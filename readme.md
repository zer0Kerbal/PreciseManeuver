...
[![PreciseManeuver (ABBV)][MOD:shd:latest]][MOD:forum] [![KSP version][KSP:shd]][KSP:url]  [![License][LIC:shd]][LIC:url]  
...
<img src="https://raw.githubusercontent.com/zer0Kerbal/PreciseManeuver/master/img/HeroLogo_1920x1920.png" alt="PreciseManeuver Hero" width="50%" height="50%">



### Preamble by [`Morse`][morse]

> If you were ever frustrated with the default maneuver UI, don't be! With this plugin you can edit your maneuvers precisely, and always get the desired result. In the current version of the plugin you can choose the tools you need from the wide assortment of modules, and customize it for yourself.

### Usage by [Morse][morse]

The toolbar icon will appear during the mapview, and by pressing on it you can enable and disable various components of the plugin. Here is the list of available modules:
...
### YouTube showcase by [`Geneborg`](https://www.youtube.com/@Geneborg)

old but still relevant

[![KSP Mod Showcase - Precise Node](https://img.youtube.com/vi/IcTQ4YwxLGc/0.jpg)](https://youtu.be/IcTQ4YwxLGc)
...
<!-- mod links -->
[MOD:attr]: https://zer0kerbal.github.io/PreciseManeuver/Attributions "Attribution"
...
[MOD:issue]: https://github.com/zer0Kerbal/PreciseManeuver/issues "Issues"
[MOD:markt]: https://zer0kerbal.github.io/PreciseManeuver/Marketing "Marketing Slicks"
[MOD:notic]: https://zer0kerbal.github.io/PreciseManeuver/Notices "Notices"
[MOD:pages]: https://zer0kerbal.github.io/PreciseManeuver "GitHub Pages"
[MOD:works]: https://zer0kerbal.github.io/PreciseManeuver/HowItWorks "How It Works"
...
[CODE:shd]: https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/zer0Kerbal/PreciseManeuver/master/json/code.json
...
[SPCDCK:url]: http://spacedock.info/mod/2998 "SpaceDock"
...
Track progress: issues [here][MOD:issue] and projects [here](https://github.com/zer0Kerbal/PreciseManeuver/projects/) along with **[The Short List](https://github.com/users/zer0Kerbal/projects/27)**
